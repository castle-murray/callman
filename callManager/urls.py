...
urlpatterns = [
    ...
    path('worker/<int:worker_id>/increment-nocallnoshow/', workers.increment_nocallnoshow, name='increment_nocallnoshow'),
    path('worker/<int:worker_id>/decrement-nocallnoshow/', workers.decrement_nocallnoshow, name='decrement_nocallnoshow'),
    path('worker/edit/<int:worker_id>/', workers.edit_worker, name='edit_worker'),
    path('worker/import/', workers.import_workers, name='import_workers'),
    ...
    path('call/track/htmx-time-sheet-row/<int:id>/', call_times.htmx_time_sheet_row, name='htmx_time_sheet_row'),
    path('call-time/<slug:slug>/copy/', call_times.copy_call_time, name='copy_call_time'),
    path('confirm-time-change/<uuid:token>/', call_times.confirm_time_change, name='confirm_time_change'),
    path('call-time-confirmations/<slug:slug>/', call_times.call_time_confirmations, name='call_time_confirmations'),
